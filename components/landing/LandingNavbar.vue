...
const testApiInteraction = async () => {
   const { data } = await useFetch('http://127.0.0.1:3333/')
   alert(data.value.hello)
}
</script>

<template>
   <nav class="sticky top-0 border-b border-b-gray-100 px-4 lg:px-6 py-2.5 backdrop-blur text-storm-dark">
      <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
         <a href="#" class="flex items-center">
            <nuxt-img
               ...
               alt="StudyStorm Logo"
            />
            <span class="self-center text-xl font-semibold whitespace-nowrap font-[ZwoDrei]">StudyStorm</span>
         </a>
