...
<template>
   <nav class="sticky top-0 border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800 backdrop-blur">
      <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
         <a href="#" class="flex items-center">
            <img
               ...
               alt="Flowbite Logo"
            />
            <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">StudyStorm</span>
         </a>
