  ...
  <FlippableCard :is-flippable="false">
    ...
    >
      ...
      <ul class="grid w-full gap-2 md:grid-cols-2">
        <li v-for="(answer, i) in answers" :key="i" class="">
          <input
            :id="`input${i}`"
          ...
          <label
            ...
            class="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-lg border-2 border-gray-200 bg-white p-3 text-gray-500 hover:text-gray-600 peer-checked:text-gray-600 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300 dark:peer-checked:text-gray-300"
          >
            <span class="block w-full text-sm">{{ answer.label }}</span>
          </label>
        </li>
      </ul>
      <div class="my-2 w-40" style="margin-left: auto; margin-right: auto">
        <button
          type="button"
