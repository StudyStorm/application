    ...
    <div class="mx-auto flex h-full w-full max-w-xs flex-col md:justify-center">
      ...
      <div class="mt-16 w-full">
        <form @submit.prevent="sendEmail">
          ...
          <button
            type="submit"
            class="focus:ring-primary-300 mt-4 w-full rounded-lg bg-storm-blue px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-storm-darkblue focus:outline-none focus:ring-4"
          >
