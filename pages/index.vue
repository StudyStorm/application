...
<template>
  <div>
    ...
    <section class="bg-white dark:bg-gray-900">
      ...
      >
        <div class="place-self-center mr-auto lg:col-span-7">
          <h1
            class="font-[ZwoDrei] mb-4 max-w-2xl text-4xl font-extrabold leading-none md:text-5xl xl:text-6xl dark:text-white"
          >
            StudyStorm
          </h1>
          <p
          ...
          >
            Collaborez pour apprendre d’une manière nouvelle…
          </p>
        </div>
    ...
    <section id="about" class="dark:bg-gray-800">
      <div class="py-8 px-4 sm:py-16 lg:px-6">
        <div class="mb-8 lg:mb-16 text-center">
          ...
          <p class="text-gray-500 sm:text-xl dark:text-gray-400">
            L’application StudyStorm permet aux utilisateurs de créer des
            collections de cartes de révisions et de les partager. Le créateur
            d’une salle de classe peut partager ses collections à tout le monde
            ou rendre la salle de classe privée, en invitant uniquement les
            utilisateurs qu’il souhaite, à rejoindre la salle de classe.
            L'organisation des collections est semblable à un système de
            dossier. Cela permet de regrouper les cartes par sujet, chapitre,
            unité de cours, etc… La communauté peut évaluer le contenu qu’il a
            apprécié ou pas. Les collections avec le plus de votes positifs
            seront affichées sur la page d’accueil. Les cartes étant réalisées
            par des personnes, il est possible qu’il y ait des erreurs dans la
            réponse d’une carte, ou qu’il y ait une réponse plus pertinente. Les
            utilisateurs ont la possibilité de signaler une carte en proposant
            une meilleure réponse. C’est ensuite de la responsabilité du
            créateur de la carte d’appliquer le changement.
          </p>
        </div>
        <div
    ...
    <section id="team" class="bg-gray-50 dark:bg-gray-900">
      <div
      ...
      >
        <div class="mx-auto mb-8 max-w-screen-sm lg:mb-16">
          ...
          <p class="font-light text-gray-500 sm:text-xl dark:text-gray-400">
            Nous sommes une équipe de cinq étudiants en ingénierie logicielle de
            la HEIG-VD
          </p>
        </div>
        <div
    ...
    <section class="bg-white dark:bg-gray-900">
      <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        <div class="mx-auto max-w-screen-sm text-center">
          ...
          >
            Commencez dès maintenant à apprendre !
          </h2>
          <p
            class="mb-6 font-light text-gray-500 dark:text-gray-400 md:text-lg"
          >
            StudyStorm est complètement gratuit et open source
          </p>
          <button
            href="#"
