            ...
            <div class="w-full p-6 md:mt-0 sm:max-w-md sm:p-8">
                ...
                <form class="mt-6 space-y-4 md:mt-24 lg:mt-24 md:space-y-5" @submit.prevent="reset">
                    <div>
                        ...
                        <input type="email" disabled value="marinelepen@gmail.com" class="bg-gray-200 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5">
                    </div>
                    <div>
